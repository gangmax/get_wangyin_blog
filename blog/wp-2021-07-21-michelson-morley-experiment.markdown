...
我的理解是，如果那真是误差，这个实验也许大概率说明了“近地面的 aether wind 不存在或很微弱”（注意限定词），却并没能证明“aether 不存在”，也没有证明“光的传播不需要介质”，更没有证明“光的速度不随观察者的运动而改变”。所有后面这些说法，似乎都是其他人的发挥甚至曲解。这就像没探测到风，就说“空气不存在”一样。另外，“近地面不存在 aether wind”，其实并不等于“不存在 aether wind”，也许在高空其实存在呢？依据如此特殊情况下的实验，就否决一切的可能性，这不能叫做“科学方法”。
